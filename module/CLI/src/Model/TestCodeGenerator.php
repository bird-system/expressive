...
class TestCodeGenerator extends AbstractCodeGenerator
{
    ...
    {
        $CodeGenerator = new BaseModuleBaseController(
            $table,
            $this->config->getBaseModule(),
            $this->config->getBaseModule() . '\\' . self::NAMESPACE_TEST . '\\' . self::NAMESPACE_CONTROLLER . '\AbstractControllerTestCase'
        );
    ...
    public function generateBaseModuleBaseModel(TableObject $table)
    {
        $CodeGenerator = new BaseModuleBaseModel(
            $table,
            $this->config->getBaseModule(),
            $this->config->getBaseModule() . '\\' . self::NAMESPACE_TEST . '\\' . self::NAMESPACE_MODEL . '\AbstractModelTest'
        );
        $CodeGenerator->setBasePath($this->getConfig()->getCodeBasePath());
        $CodeGenerator->setCodeDirectoryName(self::DIRECTORY_TEST);
